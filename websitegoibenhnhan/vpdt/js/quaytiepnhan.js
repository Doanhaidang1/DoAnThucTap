...
function init_DataTables() {
    table = $('#datatable-quaytiepnhan').DataTable({
        "ajax":
        {
        ...
        initComplete: function () {
            ...
            $(".add-new").click(function () {
                addRowInput($('#datatable-quaytiepnhan'), 1);
            });
            ...
            $(".save").click(function () {
                ...
                Swal.fire({
                    ...
                    text: "Hành động này sẽ thêm mới một quầy tiếp nhận!",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        if (saveData($('#datatable-quaytiepnhan'), $("#ULocal").val() + 'quaytiepnhan/saveQuayTiepNhan/', "'Quầy đã được cập nhật thành công.'")) {
                            $('#datatable-quaytiepnhan').DataTable().ajax.reload(hiddenButton);
                        }
                    }
...
$(document).ready(function () {
    ...
    $("#datatable-quaytiepnhan_filter").css({
    ...
    $(document).on("click", ".add", function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (updateData($(this), $("#ULocal").val() + 'quaytiepnhan/saveQuayTiepNhan/', 'Quầy tiếp nhận đã được cập nhật thành công.')) {
    ...
    $(document).on("click", ".edit", function () {
        addInput($('#datatable-quaytiepnhan'), $(this).closest('tr'));
    });
    ...
    $(document).on("click", ".delete", function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (deleteData(table, $(this), $("#ULocal").val() + 'quaytiepnhan/deleteQuayTiepNhan/', 'Quầy tiếp nhận đã được xóa thành công.')) {
...
function hiddenButton() {
    ...
    if ($("#role-quaytiepnhan-saveQuayTiepNhan").val() == "false") {
        $(".add-new").hide();
        $(".edit").hide();
        $(".add").hide();
        $(".save").hide();
    }
    if ($("#role-quaytiepnhan-deleteTrangThai").val() == "false") {
        $(".delete").hide();
    }
